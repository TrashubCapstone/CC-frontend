...
import Login from './components/Login'; // Misalnya Anda memiliki komponen Login
import 'bootstrap/dist/css/bootstrap.min.css'; // Import Bootstrap CSS

const App = () => {
  const [trashData, setTrashData] = useState([
    { id: 1, category: 'Sampah Makanan', type: 'Organik', description: 'Sampah makanan adalah sisa-sisa makanan yang tidak dikonsumsi dan akhirnya dibuang. Ini termasuk kulit buah dan sayur, sisa makanan yang tidak habis, makanan yang kadaluarsa, serta bahan makanan yang rusak. Sampah makanan merupakan salah satu komponen terbesar dari limbah rumah tangga dan restoran. Di banyak tempat, sampah makanan juga berasal dari proses produksi, distribusi, dan penyimpanan makanan',
      recycle: 'Pengomposan dan Pakan Ternak'},    
    { id: 2, category: 'Kaca', type: 'Anorganik', description: 'Sampah kaca meliputi berbagai produk yang terbuat dari kaca seperti botol, gelas, jendela, dan peralatan rumah tangga lainnya. Kaca adalah bahan anorganik yang dibuat dari silika (pasir), soda, dan kapur yang dipanaskan hingga meleleh dan kemudian dibentuk sesuai kebutuhan. Kaca adalah bahan yang dapat didaur ulang berkali-kali tanpa kehilangan kualitas atau kemurniannya.' , 
        recycle:'Produk Kreatif dan Bahan Bangunan'},
  ]);
